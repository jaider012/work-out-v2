...
## 5. Hevy-parity features — iteration 11 update (final polish)

- ✅ **Workout complete** celebration screen replaces the bare alert: big
  check icon, PR banner when applicable, stats card, per-exercise summary
  and a **Share workout** button that posts a plain-text summary via the
  native share sheet.
- ✅ Finishing a workout now routes to `/workout-complete` (modal) with
  the saved workout id + PR count rather than dumping back to the tabs.
- ✅ README.md rewritten to document the full feature map, scripts and
  project layout.

## 6. Hevy-parity features — iteration 10 update
...
## 7. Hevy-parity features — iteration 9 update
...
## 8. Hevy-parity features — iteration 8 update
...
## 9. Hevy-parity features — iteration 7 update
...
## 10. Hevy-parity features — iteration 6 update
...
## 11. Hevy-parity features — iteration 5 update
...
## 12. Hevy-parity features — iteration 4 update
...
## 13. Hevy-parity features — iteration 3 update
...
## 14. Hevy-parity features — earlier iterations
